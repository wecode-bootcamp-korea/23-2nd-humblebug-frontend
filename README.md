...
- 디자인이 깔끔하고 크라우드 펀딩 프로젝트 CRUD와 후원 부분이 구현하면서 배울 점이 많을 것 같아 선정했습니다.
...
- KaKao REST API KEY를 활용한 소셜로그인 기능 구현
- fetch함수를 활용한 백엔드 통신, 페이지 데이터 렌더링

#### 메인페이지

- Slick Slide 라이브러리를 활용한 캐러셀 기능 구현
